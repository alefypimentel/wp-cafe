	...
	public function kirki_init()
	{
		...
		Kirki::add_field(
			...
			array(
				'type'        => 'image',
				'settings'    => 'logo',
				'label'       => __( 'Logo', 'resuta' ),
				'section'     => 'title_tagline',
				'description' => __( 'The logo image of the site will be used in the header and footer. Suggested size <strong>90</strong> pixels in height by <strong>30</strong> pixels in width.', 'resuta' ),
			)
		);
	...
	public function handle_colors()
	{
		Kirki::add_field(
			...
			array(
				...
				'label'    => __( 'Android Chrome theme color', 'resuta' ),
				'section'  => 'colors',
			)
		);
	}
